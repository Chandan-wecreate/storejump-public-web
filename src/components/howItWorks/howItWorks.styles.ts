const howItWorksStyles = {
    ...
    card: "grid auto-rows-auto gap-[15px]",
    scrollCard: "will-change-transform",
    revealCardBase: "opacity-40 grayscale will-change-[opacity,filter]  rounded-[20px] shadow-[2px_4px_5px_2px_#8080803d]",
    ...
    img: "w-full h-full",
    cardInfoWrapper: "grid auto-rows-auto gap-2.5 lg:gap-[15px]  p-3",
